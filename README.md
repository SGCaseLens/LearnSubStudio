...
一个强大的 YouTube 视频双语字幕学习工具，可以从 YouTube 视频自动生成带有英中双语字幕、可视化效果和学习笔记的学习视频。
...
- 📊 **分层字幕设计**: 英文主焦点(48px)在上方，中文辅助理解(38px)在下方，层次清晰更舒适
...
- **英文主焦点**: 48px字体，纯白色，粗体边框，视觉突出，位于上方
- **中文辅助理解**: 38px字体，灰白色，细边框，清晰可读，位于下方  
- **位置分离**: 英文上方，中文下方，60px舒适间距，层次清晰
